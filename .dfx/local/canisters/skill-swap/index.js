...
import { idlFactory } from './skill-swap.did.js';
export { idlFactory } from './skill-swap.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SKILL_SWAP;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./skill-swap.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the skill-swap canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./skill-swap.did.js")._SERVICE>}
 */
export const skill_swap = createActor(canisterId);
